...
export default function DemoNavbar() {
  ...
  const demoPages = [
    ...
    { path: '/find-your-way-demo-standalone', label: 'Find Your Way (Enhanced)', category: 'Maps' },
    { path: '/find-your-way-v2-demo', label: 'Find Your Way V2', category: 'Maps' },
    { path: '/find-your-way-v2-demo-standalone', label: 'Find Your Way V2 (Enhanced)', category: 'Maps' },
    { path: '/map-directions-standalone', label: 'Map Directions (Clean)', category: 'Maps' },
    { path: '/history-timeline-demo', label: 'History Timeline', category: 'Content' },
