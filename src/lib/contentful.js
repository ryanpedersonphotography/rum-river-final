// JSON API configuration for local file-based CMS
const API_BASE_URL = 'http://localhost:3001'

// Helper function to get HomePage content from JSON API
export async function getHomePageContent() {
  try {
    ...
    console.warn('JSON API not available. Using fallback content.', error)
...
// Simple client object for compatibility
const client = {
  getHomePageContent
}
