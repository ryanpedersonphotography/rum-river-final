...
export default function CohesiveDesign() {
  console.log('CohesiveDesign component rendering');
  useEffect(() => {
          ...
          <div className="header-content">
            ...
            <nav>
              <ul className="nav-menu">
                ...
                <li><a href="#packages">Investment</a></li>
        ...
        <div className="content-wrapper">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <button className="romantic-button primary">Schedule Your Visit</button>
              <button className="romantic-button outline">View Our Gallery</button>
            </div>
          </div>
        </div>
        ...
        <div className="content-wrapper">
          ...
          <div className="packages-grid">
            ...
            <div className="package-card featured">
              ...
              <button className="romantic-button primary full-width">Book Consultation</button>
            </div>
      ...
      <footer className="footer-contact">
        <div className="footer-container">
          ...
          <div className="footer-buttons">
            ...
            <a href="#contact" className="footer-contact-button">REQUEST PRICING</a>
          </div>
          <p className="footer-address">
            📍 12500 Rum River Drive, Princeton, MN 55371<br />
            📞 (763) 555-BARN | ✉️ hello@rumriverweddings.com
          </p>
        </div>
      </footer>
    </>
